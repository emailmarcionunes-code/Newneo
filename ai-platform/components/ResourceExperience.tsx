            ...
            >
                ...
                <section className="panel">
                  ...
                  <dl className="surfaceFacts">
                    {[
                      [
                        'Provider',
                        providers.find((p) => p.id === detail.provider)?.name ??
                          detail.provider,
                      ],
                    ...
                    <Button
                      ...
                      onClick={() => {
                        patch(detail.id, {
                          connected: false,
                          sync: 'Not synchronized',
                          events: [...detail.events, 'Disconnected · preview'],
                        });
                        setNotice(
              ...
              {tab === 'Actions' && (
                <section>
                  ...
                  <p>
                    Technical availability and workspace selection are separate.
                    Selection here is a preview, not an execution grant.
                  </p>
                  <div className="surfaceCards resourceSection">
                    {(
                      toolConnectors.find((tool) => tool.id === detail.provider)
                        ?.actions ?? []
                    ).map((action) => (
                      <article className="agentCard" key={action.id}>
                        ...
                        <label className="resourceCheck">
                          <input
                            ...
                            checked={detail.selectedActions.includes(action.id)}
                            onChange={(e) =>
                              patch(detail.id, {
                ...
                <section className="panel">
                  ...
                  <dl className="surfaceFacts">
                    ...
                    <div>
                      ...
                      <dd>Requires evaluation against the connected content</dd>
                    </div>
                  </dl>
                </section>
              )}
