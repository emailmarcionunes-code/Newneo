...
The interactive Skill lifecycle now exists as a session-only demo; see [ADR-002](../../docs/decisions/ADR-002-SKILL-LIFECYCLE.md). This does not implement a live Skill API or change this OpenAPI proposal. The runtime migration and immutable SkillVersion endpoints remain prerequisites.
